...
import { IProfile } from 'common/define-types';
export default class EmployeeApi {
    static host = SYSTEM_CONSTANTS.HRM.HOST;

    static getEmployeeInfo(): Observable<any> {
        const api = `${EmployeeApi.host}/${SYSTEM_CONSTANTS.HRM.GET_USER_INFO}`;
    ...
    static updateEmployeeInfo(body: IProfile): Observable<any> {
        const api = `${
            EmployeeApi.host
        }/${SYSTEM_CONSTANTS.HRM.UPDATE_USER_INFO(body.id)}`;
